...
/**
 * ════════════════════════════════════════════════════════════════
 * `error.tsx` — حد أمان لأي صفحة تحت `(dash)` بتقع أثناء الرندر
 * (المرحلة ٨ — المتانة)
 *
...
export default function DashError({
  ...
  useEffect(() => {
    reportError(error, { scope: 'dash-error-boundary' });
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-canvas">
      <PageHeader
        ...
        subtitle="باقي لوحة التحكم شغّالة عادي — جرّب تفتح الصفحة تاني"
        motif="swoosh"
      />
      <Sheet>
